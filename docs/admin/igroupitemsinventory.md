# Retrieve Access Token List Inventory

### API Overview
- **Resource Name:** `inventory`
- **Sub Resource Name:** `retrieve_access_token_list_inventory`
- **Method:** `GET`
- **Invoke URL:** `https://xqaizmksl2.execute-api.us-west-2.amazonaws.com/test/inventory/group/items`
- **Lambda Function:** ``
...
def lambda_handler(event, context):
    ...
    urlss = "https://www.zohoapis.in/inventory/v1/itemgroups?organization_id=60015333937&page=1&per_page=50"
