...
- **Sub Resource Name:** `specific_user_report`
- **Method:** `PUT`
- **Invoke URL:** `https://xqaizmksl2.execute-api.us-west-2.amazonaws.com/test/travel_plan/specific_user_report`
- **Lambda Function:** `avana_teavel_plan_get`
